...
public class LibManager {
  ...
  public static final String[] albumProjection = new String[] {
      ...
      MediaStore.Audio.Media.ARTIST_ID, MediaStore.Audio.Albums.LAST_YEAR,
  ...
  public static final String[] playListSongProjection = new String[] {
      MediaStore.Audio.Playlists.Members.TITLE, MediaStore.Audio.Playlists.Members.AUDIO_ID,
      MediaStore.Audio.Playlists.Members.ARTIST, MediaStore.Audio.Playlists.Members.ALBUM,
      MediaStore.Audio.Playlists.Members.DURATION, MediaStore.Audio.Playlists.Members.DATA,
  ...
  public static ArrayList<Song> scanSongs(Context context) {
    ...
    Cursor cursor = context.getContentResolver()
        .query(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, songsProjection,
    ...
    for (int i = 0; i < cursor.getCount(); i++) {
      ...
      Song song = new Song(cursor.getInt(cursor.getColumnIndex(MediaStore.Audio.Media._ID)),
          ...
          (cursor.getString(cursor.getColumnIndex(MediaStore.Audio.Media.ARTIST))).equals(
              MediaStore.UNKNOWN_STRING) ? context.getString(R.string.no_artist)
  ...
  public static ArrayList<Artist> scanArtists(Context context) {
    ...
    Cursor cursor = context.getContentResolver()
        .query(MediaStore.Audio.Artists.EXTERNAL_CONTENT_URI, artistProjection, null, null,
            MediaStore.Audio.Artists.ARTIST + " ASC");

    for (int i = 0; i < cursor.getCount(); i++) {
      cursor.moveToPosition(i);
      Artist artist = new Artist(cursor.getInt(cursor.getColumnIndex(MediaStore.Audio.Artists._ID)),
          (cursor.getString(cursor.getColumnIndex(MediaStore.Audio.Artists.ARTIST))
              .equals(MediaStore.UNKNOWN_STRING)) ? context.getString(R.string.no_artist)
              : cursor.getString(cursor.getColumnIndex(MediaStore.Audio.Artists.ARTIST)),
  ...
  public static ArrayList<Album> scanAlbums(Context context) {
    ...
    Cursor cursor = context.getContentResolver()
        .query(MediaStore.Audio.Albums.EXTERNAL_CONTENT_URI, albumProjection, null, null,
            MediaStore.Audio.Albums.ALBUM + " ASC");

    for (int i = 0; i < cursor.getCount(); i++) {
      cursor.moveToPosition(i);
      Album album = new Album(cursor.getInt(cursor.getColumnIndex(MediaStore.Audio.Albums._ID)),
  ...
  public static ArrayList<PlayList> scanPlayList(Context context) {
    ...
    for (int i = 0; i < cursor.getCount(); i++) {
      cursor.moveToPosition(i);
      PlayList playList =
          new PlayList(cursor.getInt(cursor.getColumnIndex(MediaStore.Audio.Playlists._ID)),
  ...
  public static ArrayList<Genre> scanGenres(Context context) {
    ...
    Cursor cursor = context.getContentResolver()
        .query(MediaStore.Audio.Genres.EXTERNAL_CONTENT_URI, genreProjection, null, null,
    ...
    for (int i = 0; i < cursor.getCount(); i++) {
      ...
      //将歌曲与类型关联
      Cursor genreCursor = context.getContentResolver()
  ...
  public static boolean isEmpty() {
    ...
    if (mSongLib.isEmpty() && mArtistLib.isEmpty() && mAlbumLib.isEmpty() && mPlayListLib.isEmpty()
        && mGenreLib.isEmpty()) {
      flag = true;
    }
  ...
  public static ArrayList<Song> getPlayListSongs(Context context, PlayList playList) {
    ...
    Cursor cursor = context.getContentResolver()
        .query(
            ...
            playListSongProjection, MediaStore.Audio.Media.IS_MUSIC + " != 0", null, null);
  ...
  public static PlayList deletePlaylist(final Context context, final PlayList playlist) {
    ...
    context.getContentResolver()
        .delete(MediaStore.Audio.Playlists.EXTERNAL_CONTENT_URI,
            MediaStore.Audio.Playlists._ID + "=?", new String[] { playlist.getmPlayListId() + "" });
   ...
   * 向歌单添加音乐
   */
  public static void addSongToPlaylist(final Context context, final PlayList playlist,
      final Song song) {
    Cursor cur = context.getContentResolver()
        .query(
            MediaStore.Audio.Playlists.Members.getContentUri("external", playlist.getmPlayListId()),
            null, null, null, MediaStore.Audio.Playlists.Members.TRACK + " ASC");
   ...
   * 批量向歌单添加音乐
   */
  public static void addSongListToPlaylist(final Context context, final PlayList playlist,
