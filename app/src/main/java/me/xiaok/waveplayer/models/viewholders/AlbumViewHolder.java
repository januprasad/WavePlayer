...
public class AlbumViewHolder extends RecyclerView.ViewHolder
  ...
  public void updateViewHolder(Album album) {
    if (mPaletteTask != null && !mPaletteTask.isCancelled()) mPaletteTask.cancel(true);
    ...
    ImageRequest request =
        ImageRequestBuilder.newBuilderWithSource(Uri.parse("file://" + album.getmAlbumArt()))
    ...
    if (colorCache == null) {
      ...
      DataSource<CloseableReference<CloseableImage>> dataSource =
          imagePipeline.fetchDecodedImage(request, WaveApplication.getContext());
  ...
  @Override public void onGenerated(Palette palette) {
    ...
    backgroundAnimator = ObjectAnimator.ofObject(mRoot, "backgroundColor", new ArgbEvaluator(),
        defaultBackgroundColor, bgColor);
    titleAnimator =
        ObjectAnimator.ofObject(mAlbumName, "textColor", new ArgbEvaluator(), defaultTitleColor,
            titleColor);
    subTitleAnimator =
        ObjectAnimator.ofObject(mArtistName, "textColor", new ArgbEvaluator(), defaultSubTitleColor,
            subTitleColor);
