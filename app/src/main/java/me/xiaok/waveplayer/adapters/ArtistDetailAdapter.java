...
public class ArtistDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ArtistDetailAdapter(Context context, ArrayList<Album> albumList, ArrayList<Song> songList) {
    ...
    public int getItemViewType(int position) {
        ...
        else if (position <= mAlbumList.size()) return ALBUM_VIEW;
        else if (position == mAlbumList.size() + 1) return HEAD_VIEW;
