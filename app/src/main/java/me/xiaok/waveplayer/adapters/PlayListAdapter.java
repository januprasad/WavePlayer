...
public class PlayListAdapter extends RecyclerView.Adapter<PlayListViewHolder> {
  ...
  @Override public PlayListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    holder.setPlayListRemoveListener(new PlayListViewHolder.PlayListRemoveListener() {
      @Override public void playListRemoved(PlayList playList) {
  ...
  @Override public void onBindViewHolder(PlayListViewHolder holder, int position) {
  ...
  public void notifyPlayListRemove(PlayList removed) {
    if (mPlayLists.contains(removed)) notifyItemRemoved(mPlayLists.indexOf(removed));
